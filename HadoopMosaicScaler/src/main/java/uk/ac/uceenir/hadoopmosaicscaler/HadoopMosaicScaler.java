...
import pyramidconfigbuilder.PyramidConfigBuilder;
...
public class HadoopMosaicScaler extends Configured implements Tool{
    ...
    private PyramidConfigBuilder.PyramidParams pyramidParams = new PyramidConfigBuilder.PyramidParams();
    ...
    public int run(String[] args) throws Exception {
        ...
        if(generateConfig) PyramidConfigBuilder.start(pyramidParams);
