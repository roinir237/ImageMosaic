...
public class PyramidBinTile {
    ...
    public int getTileWidthInBin() {
        ...
        int tileXInBin = getTileXInBin();
        return tileXInBin + width > binWidth ? binWidth - tileXInBin : width - tileXInBin;
    }

    public int getTileHeightInBin() {
        int binHeight = bin.getImageHeight();
        int tileYInBin = getTileYInBin();
        return tileYInBin + height > binHeight ? binHeight - tileYInBin : height - tileYInBin;
    }
    ...
    public PyramidBinTile fromString(String str, String name) throws IOException {
    ...
    private int [] parseString(String str, String delim) throws IOException {
        str = str.trim();
